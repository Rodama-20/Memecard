"""Defines URL patterns for memecard application.
...
urlpatterns = [
    ...
    path(
        "decks/<int:deck_id>/subscribe/", views.decks_subscribe, name="decks_subscribe"
    ),
    path(
        "decks/<int:deck_id>/unsubscribe/",
        views.decks_unsubscribe,
        name="decks_unsubscribe",
    ),
