...
def review(request, face_face_user_id):
    ...
    if request.method == 'POST':
        ...
        sm = SMTwo(review.easiness_factor, review.repetition, review.interval).review(evaluation)
